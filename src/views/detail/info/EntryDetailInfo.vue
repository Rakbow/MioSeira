...
<template>
  <ul id="infobox">
    ...
    <li v-if="entry.type === META.ENTRY_TYPE.PERSON || entry.type === META.ENTRY_TYPE.CHARACTER">
    ...
    <li v-if="entry.type !== META.ENTRY_TYPE.CLASSIFICATION && entry.type !== META.ENTRY_TYPE.MATERIAL">
      <span class="tip">{{ $t('Date') }}:&nbsp;</span>{{ entry.date }}
    </li>
